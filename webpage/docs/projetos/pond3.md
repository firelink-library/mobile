...
sidebar_position: 4
slug: /pond3
title: "Desenvolvimento com Android Nativo"
---
...
## Desenvolvimento de Aplicativo com Android Nativo
...
Pessoal, realizar está implementação, necessariamente com Kotlin, é um dos requisitos para a entrega do projeto. Contudo, o projeto pode ser implementado com Java, mas isso não é o esperado. O objetivo aqui é que vocês consigam realizar a implementação do projeto utilizando Kotlin. Caso você tenha alguma dúvida sobre isso, não deixe de perguntar.

<img  
  src='https://kotlinlang.org/_next/static/chunks/images/hero-cover-6dd34ed75729683235a4f47d714a604e.png' alt="Tela de Login"
...
- [Documentação do Android](https://developer.android.com/develop?hl=pt-br)
- [Canal Youtube Alex Felipe](https://www.youtube.com/@AlexFelipeDev/videos)

<iframe width="560" height="315" src="https://www.youtube.com/embed/EExSSotojVI?si=CPlFk4sf3GJP_zzC" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen
style={{ display: 'block', marginLeft: 'auto', maxHeight: '40vh', marginRight: 'auto', marginBottom: '24px' }}></iframe>
<br />

<iframe width="560" height="315" src="https://www.youtube.com/embed/dzUc9vrsldM?si=8TEhKnHlajm_TyYp" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen
style={{ display: 'block', marginLeft: 'auto', maxHeight: '40vh', marginRight: 'auto', marginBottom: '24px' }}></iframe>
<br />

<iframe width="560" height="315" src="https://www.youtube.com/embed/RVfEqMWi7x8?si=wFHz_noC8QM3YgRS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen
style={{ display: 'block', marginLeft: 'auto', maxHeight: '40vh', marginRight: 'auto', marginBottom: '24px' }}></iframe>
<br />